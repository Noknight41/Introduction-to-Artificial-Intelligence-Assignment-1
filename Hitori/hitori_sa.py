...
class Hitori:
    ...
    def __checkDubs(self, pos, check_arr_hor, check_arr_ver):
        dub = 0
    ...
    def __initSolver(self, tempHitori):
        if 2 < self.dimension:
    ...
    def __madeNewChange(self, old_score, temperature, keys):
